      ...
      <main className="container mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
            A Next.js application with TypeScript, TailwindCSS 3.4.17, and Sanity CMS for theme development and testing.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-5xl mx-auto mb-12">
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Sanity CMS</h3>
              <p className="text-gray-600 dark:text-gray-300">Headless content management</p>
            </div>
          </div>
          ...
          <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-6 mb-8 max-w-3xl mx-auto">
            ...
            <p className="text-yellow-700 dark:text-yellow-300 mb-4">
              To use the CMS features, you need to create a Sanity project and configure your environment variables:
            </p>
            <ol className="text-left text-yellow-700 dark:text-yellow-300 space-y-2">
              <li>1. Create a Sanity project at <a href="https://www.sanity.io/manage" className="underline" target="_blank" rel="noopener noreferrer">sanity.io/manage</a></li>
              <li>2. Copy <code className="bg-yellow-100 dark:bg-yellow-800 px-1 rounded">.env.example</code> to <code className="bg-yellow-100 dark:bg-yellow-800 px-1 rounded">.env.local</code></li>
              <li>3. Add your project ID and dataset to the environment variables</li>
              <li>4. Access the CMS at <a href="/studio" className="underline">/studio</a></li>
            </ol>
          </div>
